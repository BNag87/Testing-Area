//reqrep: 
//Purpose is to take data from the websocket and translate the replies that the backend give in to the
//right data structures in the front-end

//---→[update appropriate structures]
//  !-responses given as a json string-!
